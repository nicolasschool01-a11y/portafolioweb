    ...
    for (const body of leadsData) {
      ...
      const lead = await db.lead.create({
        data: {
          ...
          budget: budget || "",
          contentNeeds: Array.isArray(contentNeeds) ? JSON.stringify(contentNeeds) : (contentNeeds || null),
          demoGoal: demoGoal || null,
          extraFeatures: Array.isArray(extraFeatures) ? JSON.stringify(extraFeatures) : (extraFeatures || null),
